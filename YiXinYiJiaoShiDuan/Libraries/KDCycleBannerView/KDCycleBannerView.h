...
@optional
- (void)cycleBannerView:(KDCycleBannerView *)bannerView didScrollToIndex:(NSInteger)index;
- (void)cycleBannerView:(KDCycleBannerView *)bannerView didSelectedAtIndex:(NSInteger)index;
