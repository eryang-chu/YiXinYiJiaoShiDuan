...
@interface SBPageFlowView : UIView<UIScrollViewDelegate>{
    ...
    NSMutableArray<UIView *>     *_reusableCells;     //UnseedCell
    NSMutableArray      *_inUseCells;        //using Cell
    
    CGFloat _minimumPageAlpha;          //default is 1.0
    CGFloat _minimumPageScale;          //default is 1.0
    
    __unsafe_unretained id <SBPageFlowViewDataSource>  _dataSource;
    __unsafe_unretained id <SBPageFlowViewDelegate>    _delegate;

}


@property (assign, nonatomic) BOOL isHiddenPageControl;
...
@property (assign, nonatomic) CGFloat paddingWidth; //
